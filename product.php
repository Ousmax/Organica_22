...
$url =  explode('organica22/product',Router::getUrl());
...
<head>
    ...
    <link rel="icon" href="/organica22/img/minilogo.png" type="image/icon type">
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" type="text/css" href="/organica22/media/css/main.css">
    <link rel="stylesheet" type="text/css" href="/organica22/media/css/util.css">
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="/organica22/media/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="/organica22/media/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="/organica22/media/css/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="/organica22/media/css/magnific-popup.css" type="text/css">
    <link rel="stylesheet" href="/organica22/media/css/nice-select.css" type="text/css">
    <link rel="stylesheet" href="/organica22/media/css/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="/organica22/media/css/slicknav.min.css" type="text/css">
    <link rel="stylesheet" href="/organica22/media/css/style.css" type="text/css">
    <link rel="stylesheet" href="/organica22/media/css/main.scss.css" type="text/css">
    <link rel="stylesheet" href="/organica22/media/css/chatroom.css">
    ...
    <link rel="stylesheet" type="text/css" href="/organica22/media/vendor/animate/animate.css">
<!--===============================================================================================-->  
    <link rel="stylesheet" type="text/css" href="/organica22/media/vendor/css-hamburgers/hamburgers.min.css">
<!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="/organica22/media/vendor/animsition/css/animsition.min.css">
<!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="/organica22/media/vendor/select2/select2.min.css">
<!--===============================================================================================-->  
    <link rel="stylesheet" type="text/css" href="/organica22/media/vendor/daterangepicker/daterangepicker.css">
<!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="/organica22/media/vendor/slick/slick.css">
<!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="/organica22/media/vendor/perfect-scrollbar/perfect-scrollbar.css">
<!--===============================================================================================-->

    <script src="/organica22/media/js/jquery-3.3.1.min.js"></script>
    <script src="/organica22/media/js/bootstrap.min.js"></script>
    <script src="/organica22/media/js/jquery.nice-select.min.js"></script>
    <script src="/organica22/media/js/jquery.nicescroll.min.js"></script>
    <script src="/organica22/media/js/jquery.magnific-popup.min.js"></script>
    <script src="/organica22/media/js/jquery.countdown.min.js"></script>
    <script src="/organica22/media/js/jquery.slicknav.js"></script>
    <script src="/organica22/media/js/mixitup.min.js"></script>
    <script src="/organica22/media/js/owl.carousel.min.js"></script>
    <script type="module" src="/organica22/media/js/main.js"></script>
    <script src="/organica22/media/vendor/animsition/js/animsition.min.js"></script>
    <script type="module" src="/organica22/media/js/main1.js"></script>
    ...
    <script src="/organica22/media/js/data.js"></script>
    <script src="/organica22/media/js/cart.js"></script>
    <script src="/organica22/media/js/cartbuttons.js"></script>
    <script src="/organica22/media/js/customJS.js"></script>
    ...
    <script src="/organica22/media/js/botInteractions.js"></script>   

    <script src="/organica22/media/js/data.js"></script>
    <script src="/organica22/media/js/category/navigation.js"></script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-7 p-b-30">
                    <div class='col-md-12'>
                    <img class='product_img' src='/organica22/<?php echo $product["img"];?>' alt="IMG-PRODUCT">
                    </div>
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                        ...
                        <!--  -->
                            <div class="">
                                ...
                                <div class='labelsDiv'>
                                    ...
                                    <img src="/organica22/img/labels.png">
                    ...
                    <div class="item-slick3 slickitem1 m-t-40">
                        <div class="wrap-pic-w pos-relative">
                            <img class='product_filler' src='/organica22/<?php echo $product["filler"] ?>' alt="IMG-PRODUCT">
                        </div>
                    </div>
